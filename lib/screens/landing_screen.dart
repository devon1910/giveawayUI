  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Container(
          ...
          padding: EdgeInsets.only(top: 90.0,right: 50.0,left: 50.0,bottom: 70.0),
          child: Column(
                  ...
                  Expanded(
                    ...
                    style: GoogleFonts.nunito(
                        textStyle: TextStyle(
                            ...
                            color: Color(0xffffffff), fontSize: 40.0, fontWeight: FontWeight.w800)),
                ...
                children: [
                  Text('Don\'t have an account?',
                      style: GoogleFonts.titilliumWeb(
                        textStyle: TextStyle(
                            decoration: TextDecoration.none,
                            color: Color(0xffffffff), fontSize: 20.0, fontWeight: FontWeight.w600),
                      ),
                      textAlign: TextAlign.center),
                  SizedBox(width: 10.0),
                  GestureDetector(
